...
namespace SX3.Tools.D3DRender.Menu.Items
{
    public class SeparatorItem : MenuItem
    {
        ...
        public override void Draw(UIRenderer ui, int valueX, int labelX, int y)
        {
            ...
            {
                Size2F titleRect = ui.MeasureString("default_font", Title);
                ...
                ui.DrawLine(firstLineX1, firstLineY1 - 1, firstLineX2, firstLineY2 - 1, SeperatorHeight, Color.Gray);
                ui.DrawLine(secondLineX1, secondLineY1 - 1, secondLineX2, secondLineY2 - 1, SeperatorHeight, Color.Gray);
                ui.DrawShadowText("", Title, firstLineX2 + SeperatorPadding, y - 10, Color.Gray);
            }
            else
            {
                ui.DrawLine(labelX, y - 1, ui.Menu.MenuWidth - SeperatorPadding, y - 1, SeperatorHeight, Color.Gray);
            }
        }
